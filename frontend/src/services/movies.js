...
class MovieDataService{
    ...
    find(query, by = "title", page = 0){
        return axios.get(`http://localhost:5000/api/v1/movies?page=${page}&${by}=${query}`);
    }
    ...
    deleteReview(id, userID){
        return axios.put(`http://localhost:5000/api/v1/movies/review`, {data: {review_id: id, user_id: userID}});
    }
